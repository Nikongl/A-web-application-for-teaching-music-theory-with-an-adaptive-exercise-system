...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # Добавить в существующую модель User (если вы её расширяете через абстрактного пользователя)
    adaptive_mode = models.BooleanField(default=True, verbose_name="Адаптивный режим")
